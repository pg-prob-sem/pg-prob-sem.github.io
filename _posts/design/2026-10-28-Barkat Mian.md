...
image:
  title: barkat.jpg
  caption: Barkat Mian
  caption_url: https://math.utk.edu/people/barkat-mian/
...
## Abstract
We study the pathwise behavior of the three-dimensional attractive one-point interaction diffusion whose law was constructed by Cranston, Koralov, Molchanov, and Vainberg in~[\emph{Random Oper. Stoch. Equ.} \textbf{18}, 73--95 (2010)], corresponding to the singular Schr\"odinger Hamiltonian
\[
\frac12\Delta+\frac{\beta}{2}\delta_0(\cdot),
\qquad \beta>0.
\]
